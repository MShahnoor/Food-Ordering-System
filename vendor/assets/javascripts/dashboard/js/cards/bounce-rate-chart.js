    ...
    var config = {
      ...
      data: {
        ...
        datasets: [{
          ...
          data: [gon.academic_user_counts[1], gon.academic_user_counts[2],gon.academic_user_counts[3],gon.academic_user_counts[4], gon.academic_user_counts[5], gon.academic_user_counts[6], gon.academic_user_counts[7], gon.academic_user_counts[8],gon.academic_user_counts[9],gon.academic_user_counts[10],gon.academic_user_counts[11],gon.academic_user_counts[12]]
        }]
      },
      options: {
        title: {
